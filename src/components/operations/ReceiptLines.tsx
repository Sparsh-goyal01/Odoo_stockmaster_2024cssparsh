...
interface ReceiptLinesProps {
  ...
  products: any[]
  locations: any[]
  onLinesChange: (lines: ReceiptLine[]) => void
  disabled?: boolean
}
  ...
  return (
    <div className="bg-white p-6 rounded-lg border border-gray-200 space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-gray-900">Receipt Lines</h2>
        {!disabled && (
                ...
                <tr key={index}>
                  ...
                  <td className="px-4 py-3">
                    <select
                      ...
                      onChange={(e) => updateLine(index, 'destinationLocationId', e.target.value)}
                      disabled={disabled}
                      className="w-full px-2 py-1 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                    >
