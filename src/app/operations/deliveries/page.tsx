...
export default function DeliveriesPage() {
  ...
  const fetchDeliveries = async () => {
    try {
      ...
      const res = await fetch(`/api/operations/deliveries?${params}`)
      const data = await res.json()
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (delivery: Delivery) => delivery.partnerName || '-',
    },
    {
      header: 'Warehouse',
      accessor: 'warehouse' as const,
      render: (delivery: Delivery) => delivery.warehouse.name,
    },
    {
      header: 'Status',
    ...
    },
    {
      ...
      render: (delivery: Delivery) => delivery.lines?.length || 0,
    },
    {
      header: 'Created',
      accessor: 'createdAt' as const,
      render: (delivery: Delivery) => new Date(delivery.createdAt).toLocaleDateString(),
    },
  ]
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => router.push('/operations/deliveries/new')}>
          + New Delivery
        </Button>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
          ...
          <Button
            variant="secondary"
            onClick={() => router.push('/operations/deliveries/new')}
            className="mt-4"
          >
