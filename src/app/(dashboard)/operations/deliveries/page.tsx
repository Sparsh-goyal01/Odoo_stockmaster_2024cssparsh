...
export default function DeliveriesPage() {
  ...
  const handlePrint = (delivery: Delivery) => {
    ...
    if (!printWindow) {
      toast.error('Please allow popups to print deliveries')
      return
    }
    ...
    const printContent = `
      ...
      <html>
        <head>
          <title>Delivery - ${delivery.documentNumber}</title>
          <style>
        ...
        <body>
          <div class="header">
            ...
            <p>Document #: ${delivery.documentNumber}</p>
          </div>
          ...
          <div class="info-section">
            <div class="info-row">
              ...
              <div class="info-value">
                <span class="status-badge status-${delivery.status.toLowerCase()}">${delivery.status}</span>
              </div>
            </div>
            <div class="info-row">
              <div class="info-label">Partner:</div>
              <div class="info-value">${delivery.partnerName || '-'}</div>
            </div>
            <div class="info-row">
              <div class="info-label">Warehouse:</div>
              <div class="info-value">${delivery.warehouse.name}</div>
            </div>
            <div class="info-row">
              <div class="info-label">Source:</div>
              <div class="info-value">${delivery.sourceLocation?.name || '-'}</div>
            </div>
            <div class="info-row">
            ...
            <tbody>
              ${delivery.lines.map((line, index) => `
                <tr>
                  ...
                  <td>${line.sourceLocation?.name || '-'}</td>
                </tr>
              `).join('')}
              <tr class="total-row">
                <td colspan="3">Total Items</td>
                <td colspan="3">${delivery.lines.length} line(s)</td>
              </tr>
            </tbody>
          </table>
